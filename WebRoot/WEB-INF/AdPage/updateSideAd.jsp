...
<body style="padding: 20px;">
	<div class="ad-content" id="ad-side">
		<form class="layui-form" id="side-form">
			<s:if test="s_ad==null">
				<input type="hidden" value="0" id="ad-id"/>
			</s:if><s:else>
				<input type="hidden" value="${s_ad.id}" id="ad-id"/>
			</s:else>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<s:else>
						<input type="text" name="ad-company" id="ad-company" lay-verify="required" placeholder="广告单位或者个人" class="layui-input input-switch" value="${s_ad.company}">
					</s:else>
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<s:else>
						<input type="text" name="ad-about" id="ad-about" lay-verify="required" placeholder="广告标题或者相关描述,长度10-20" class="layui-input input-switch" value="${s_ad.about}">
					</s:else>
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<s:else>
						<input type="text" name="ad-url" id="ad-url" lay-verify="required" placeholder="请输入一个有效的链接" autocomplete="off" class="layui-input input-switch" value="${s_ad.url}">
					</s:else>
				</div>
			</div>
			<!-- 上传广告图 -->
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="layui-upload">
						<button type="button" class="layui-btn  layui-btn-normal upload-btn" id="upload-side-img" />
